...
function Dark() {
    ...
    return (
      <> 
    <div className=" hover:left-[-2px] hover:opacity-100 transform duration-500 opacity-50 fixed flex flex-col z-50 max-md:bottom-0 md:top-1/3 left-[-14px] bg-mainBg border-lBrand  border-2 rounded-[999px] hover:cd">
      ...
      <button onClick={()=>{setDarkMode(!darkMode)}} className="flex justify-center cursor-pointer relative w-6 h-11 bg-secondaryBg overflow-hidden border-lBrand  border-2 rounded-[999px]" aria-label="Dark Mode Switch">
        <div className={`absolute w-5 h-5 border-2 duration-300 border-lBrand rounded-[999px] ${darkMode ? 'translate-y-full' : ''} bg-balBrand`}></div>
      </button>
      <div className="flex flex-row justify-center items-center">
