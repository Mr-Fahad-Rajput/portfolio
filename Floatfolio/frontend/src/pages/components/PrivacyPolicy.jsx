const PrivacyPolicy = () => {
  return (
    <div className="items-center justify-center mainContent">
      <p className="m-1 p-2 w-full" >
        <strong>PRIVACY POLICY</strong>
      </p>
      <p className="m-1 p-2 w-full" >
        <strong>Last updated September 29, 2023</strong>
      </p>
      <p className="m-1 p-2 w-full" >
        This privacy notice for Faadii&#39;s Tech (&quot;<strong>we</strong>
        ,&quot; &quot;<strong>us</strong>,&quot; or &quot;<strong>our</strong>
        &quot;), describes how and why we might collect, store, use, and/or
        share (&quot;<strong>process</strong>&quot;) your information when you
        use our services (&quot;<strong>Services</strong>&quot;), such as when
        you:
      </p>
      <ul>
        <li>
      ...
      <p className="m-1 p-2 w-full" >
        ...
        email us at fahadrajput@faadii.tech.
      </p>
      <p className="m-1 p-2 w-full" >
      ...
      <p className="m-1 p-2 w-full" >A. Identifiers</p>
      <p className="m-1 p-2 w-full" >
      ...
      <p className="m-1 p-2 w-full" >All other individuals are defined as &quot;non-residents.&quot;</p>
      <p className="m-1 p-2 w-full" >
      ...
      <p className="m-1 p-2 w-full" >Right to request deletion of the data — Request to delete</p>
      <p className="m-1 p-2 w-full" >
      ...
      <p className="m-1 p-2 w-full" >Right to be informed — Request to know</p>
      ...
      <p className="m-1 p-2 w-full" >
        ...
        , by email at fahadrajput@faadii.tech, or by referring to the contact
      ...
      <p className="m-1 p-2 w-full" >
        ...
        appeal our decision, please email us at fahadrajput@faadii.tech. Within
      ...
      <p className="m-1 p-2 w-full" >Under the Virginia Consumer Data Protection Act (VCDPA):</p>
      <p className="m-1 p-2 w-full" >
      ...
      <p className="m-1 p-2 w-full" >Right to appeal</p>
      <p className="m-1 p-2 w-full" >
        ...
        decision, please email us at fahadrajput@faadii.tech. Within sixty (60)
      ...
      <p className="m-1 p-2 w-full" >
        ...
        Data Protection Officer (DPO), Fahad Ameen Rajput, by email at
