...
const CardOne = (props) => {
  ...
  return (
    <div className="rounded-lg m-4 border-2 border-dBrand dark:border-mainBg hover:scale-110 dark:bg-mainBg bg-lBrand p-4">
      ...
      <div className="mt-4 ">
        ...
        <span className="text-lg font-medium">{subHeading}</span>
          {difPercntage}
          <img src={up} alt="Up arrow Symbol" className='h-6 w-3 pb-1'/>
        </span>
