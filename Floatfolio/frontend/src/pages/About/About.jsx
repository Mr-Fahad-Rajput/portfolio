      ...
      <section className="mainContent">
        <div>
          ...
          <div className="text-center md:flex  overflow-hidden  h-1/5 rounded-lg m-2 dark:bg-balBrand bg-secondaryBg   text-dBrand dark:text-mainBg">
            <div className="inline-flex md:float-left  md:max-w-[21vw] md:min-w-[21vw] items-center m-2">
              <img
                src={kid}
            ...
            <div className="overflow-hidden self-center p-2 pl-4">
              ...
              <b className="text-2xl">G</b>reetings! I&rsquo;m Fahad, a highly dedicated and enthusiastic
                ...
                interest in technology, and by 6, I was already exploring the
                world of computers using CLI and MS Paint, setting the stage for
                an enduring passion for programming. At the age of 11, I wrote
                my first code in Visual Basic, and from that moment onward, I
                knew that programming would be an integral part of my life.
                Throughout my journey, I&rsquo;ve been recognized as the
                &quot;computer guy&quot; wherever I went.
              </p>
            </div>
          </div>
          {/* Bachelors */}
          <div className="text-center md:flex h-1/5 m-2 overflow-hidden text-dBrand dark:text-mainBg ">
            <div className="inline-flex md:float-right md:max-w-[21vw] md:min-w-[21vw] items-center m-2">
              <img
                src={teen}
            ...
            <div className="overflow-hidden self-center p-2 pr-4">
              ...
              <b className="text-2xl">I</b> embarked on my formal education in Software Engineering at
                ...
                including C, C++, C#, Python, Java, Blender, Unity, Unreal
                Engine, and many more. My curiosity led me to explore emerging
                technologies, such as AI, ML, IOT, and cloud computing, further
                expanding my expertise in the ever-evolving tech landscape. This
                has allowed me to stay at the forefront of innovation, Equipping
                me with cutting-edge tools and techniques to build powerful
                digital solutions.
              </p>
            </div>
          </div>
          ...
          <div className="text-center md:flex h-auto rounded-lg m-2 dark:bg-balBrand bg-secondaryBg  text-dBrand dark:text-mainBg ">
            ...
            <div className="overflow-hidden self-center p-2 pl-4">
              ...
              <b className="text-2xl">I</b> am a passionate web developer with a successful career
                ...
                JavaScript, PHP, HTML, CSS, React, Redux, Node, Express,
                Three.js, and more. As a full-stack developer, I have honed my
                skills in creating captivating web experiences and possess
                expertise in handling deployment across multiple platforms,
                making me a valuable asset in the ever-evolving world of
                technology. I focus primarily on web development, constantly
          ...
          <div className=" text-center py-2 md:px-2 h-1/5 m-2 overflow-hidden text-dBrand dark:text-mainBg ">
            ...
            <div className="overflow-hidden self-center p-2 pr-4">
              ...
              <b className="text-2xl">I</b> kickstarted my journey as a Software Engineering Intern at
                ...
                skills as an Intern DevOps Engineer at Work Nation, where I
                focused on optimizing development and deployment processes,
                ensuring seamless workflows for the team.
              </p>
            </div>
          </div>
          ...
          <div className="text-center py-2 md:px-2 overflow-hidden  h-1/5 rounded-lg m-2 dark:bg-balBrand bg-secondaryBg   text-dBrand dark:text-mainBg">
            ...
            <div className=" overflow-hidden self-center p-2 pl-4">
              ...
              <b className="text-2xl">F</b>or the past 3.5 years, I thrived at K. Syndicates as a
                ...
                was rewarding, I yearned to take complete ownership of my
                projects and explore my creativity freely. This desire sparked
                my solo development journey, where I now offer my services as a
                freelance web developer, taking on diverse projects that both
                challenge and empower me.
              </p>
            </div>
          </div>
          {/* Outro */}
